...
//         <div className="w-1/2 h-full text-center p-4 flex justify-center items-center">
...
//               <button
//                 className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 hover:scale-105  active:scale-95 active:bg-blue-500 rounded"
